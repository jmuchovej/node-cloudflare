...
/**
 * Cloudflare Tunnel Configurations represents the /accounts/:accountId/cfd_tunnel/:tunnelId/configurations API endpoint.
 *
...
module.exports = auto(
  prototypal({
     ...
     * @param {string} tunnelId -  The Cloudflare Tunnel ID being modified
     ...
     * @param {Object} config - This is a json that conforms to the same syntax rules as the config.yaml.
     * @returns {Promise<Object>} The Cloudflare Tunnel Configuration object.
     */
    read: method({
      method: 'GET',
